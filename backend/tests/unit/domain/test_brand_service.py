...
class TestBrandService:
    """Tests unitarios para BrandService"""
    
    def setup_method(self):
        """Setup para cada test"""
        self.mock_repo = Mock(spec=BrandPort)
        self.service = BrandService(repo=self.mock_repo)
    ...
    def test_list_brands_success(self):
        ...
        # Act
        result = self.service.list_brands()
    ...
    def test_get_brand_by_id_success(self):
        ...
        # Act
        result = self.service.get_brand(brand_id)
    ...
    def test_create_brand_success(self):
        ...
        # Act
        result = self.service.create_brand(dto)
    ...
    def test_update_brand_success(self):
        ...
        # Act
        result = self.service.update_brand(brand_id, dto)
    ...
    def test_update_brand_not_found(self):
        ...
        with pytest.raises(ValueError, match=f"Brand with id {brand_id} not found"):
            self.service.update_brand(brand_id, dto)
